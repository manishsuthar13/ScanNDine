...
export const api = {
  ...
  createItem: (data) => axios.post(`${API_BASE}/menu/items`, data, { headers: getAuthHeaders() }),
  updateItem: (id, data) => axios.put(`${API_BASE}/menu/items/${id}`, data, { headers: getAuthHeaders() }),
